...
for i in range(360):  # do these steps 360 times
    right(1)      # change heading 1 degree
...
# whatever shape you like.  Can you make it go around
# in a circle?  (Not just jump back and forth to
# the perimeter the way the given code does.)
